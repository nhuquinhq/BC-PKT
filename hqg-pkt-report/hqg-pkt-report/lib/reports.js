...
export const REPORTS = [
  /* ---------------------------------------------------------- PKT1 */
  {
    ...
    charts: [
      ...
      { id: 'c_cltg', title: 'Lãi/lỗ chênh lệch tỉ giá theo tháng', type: 'bar', table: 'fx_pl', x: 'thang', series: [{ key: 'tong_cltg', label: 'Tổng CLTG' }] },
    ],
  },
  ...
  /* ---------------------------------------------------------- PKT6 */
  {
    ...
    periods: ['week', 'month', 'quarter'],
    defaultPeriod: 'month',
    source: 'GoX / ODP · P&L bóc theo Team-SPDV',
    purpose: [

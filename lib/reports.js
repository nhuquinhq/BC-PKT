...
const cpvTeamReport = (code, bu) => ({
  ...
  charts: [
    { id: 'c_ngay', title: `Cơ cấu Doanh thu theo ngày (cột chồng 100%) · ${code}`, type: 'bar', pct: true, table: 'cpv_ngay', x: 'ngay', series: [{ key: 'ty_le_co', label: '% Giá vốn', stack: true }, { key: 'bien_ln', label: '% Lợi nhuận', stack: true }] },
    { id: 'c_san', title: `Cơ cấu Doanh thu theo Sàn (cột chồng 100%) · ${code}`, type: 'bar', pct: true, table: 'cpv_san', x: 'san', series: [{ key: 'ty_le_co', label: '% Giá vốn', stack: true }, { key: 'bien_ln', label: '% Lợi nhuận', stack: true }] },
...
export const REPORTS = [
  ...
  /* ---------------------------------------------------------- PKT8 */
  {
    ...
    charts: [
      { id: 'c_ngay', title: 'Cơ cấu Doanh thu theo ngày — % Giá vốn vs % Lợi nhuận (cột chồng 100%)', type: 'bar', pct: true, table: 'cpv_ngay', x: 'ngay', series: [{ key: 'ty_le_co', label: '% Giá vốn', stack: true }, { key: 'bien_ln', label: '% Lợi nhuận', stack: true }] },
      ...
      { id: 'c_san', title: 'Cơ cấu Doanh thu theo Sàn — % Giá vốn vs % Lợi nhuận (cột chồng 100%)', type: 'bar', pct: true, table: 'cpv_san', x: 'san', series: [{ key: 'ty_le_co', label: '% Giá vốn', stack: true }, { key: 'bien_ln', label: '% Lợi nhuận', stack: true }] },
  ...
  /* ---------------------------------------------------------- PKT9 · Tầng 4 Đối soát */
  {
    ...
    tables: [
      ...
      },
      {
        ...
        hint: 'Đơn có Order ID xuất hiện ở cả hai file (kể cả khác đuôi -1/-2). Báo cáo PKT8 chỉ tính các đơn này MỘT LẦN theo module Quản lý đơn hàng; bảng module tính ở cả hai dòng. Cột chênh lệch = Doanh thu API − Doanh thu BE — dòng lệch khác 0 là hai module ghi số khác nhau cho cùng một đơn.',
        totals: true,
        columns: [

...
const CPV_SHEET_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vR2a1Pm2KCjtqZpgQa_KNMbtaDI0ksX6TXoRLHf3eEXuuW-V5ywbupEMZqhByobaHu7BGe1dYNNL0St/pubhtml?gid=0&single=true';
...
export const REPORTS = [
  ...
  /* ---------------------------------------------------------- PKT10 · Tầng 4 Đối soát */
  {
    ...
    kpis: [
      { key: 'so_don', code: 'ORD', label: 'Đơn chưa có giá vốn', type: 'num', tone: 'loss' },
      { key: 'gmv', code: 'GMV', label: 'GMV chưa bóc vốn (VND)', type: 'money', tone: 'warn' },
      { key: 'doanh_thu_usd', code: 'USD', label: 'Doanh thu gốc (USD)', type: 'usd' },
    ],
    tables: [
      {
      ...
      {
        id: 'cpv_san',
        title: 'Đơn chưa có vốn theo SÀN',
        totals: true,
        columns: [
          { key: 'san', label: 'Sàn', type: 'text' },
          { key: 'bu', label: 'BU', type: 'text' },
      ...
      {
        id: 'kqkd_team',
        title: 'Đơn chưa có vốn theo TEAM',
        totals: true,
        columns: [
          { key: 'team', label: 'Team', type: 'text' },
          { key: 'so_don', label: 'Số đơn', type: 'num' },
          { key: 'gmv', label: 'Doanh thu (VND)', type: 'money' },
        ],
      },
      {
        id: 'cpv_thang',
        title: 'Đơn chưa có vốn theo THÁNG',
        totals: true,
        columns: [
          { key: 'thang', label: 'Tháng', type: 'text' },
          { key: 'so_don', label: 'Số đơn', type: 'num' },
    ...
    charts: [
      { id: 'c_ngay', title: 'Số đơn chưa có vốn theo NGÀY', type: 'bar', table: 'cpv_ngay', x: 'ngay', series: [{ key: 'so_don', label: 'Số đơn' }] },
      { id: 'c_san', title: 'GMV chưa bóc vốn theo SÀN', type: 'bar', table: 'cpv_san', x: 'san', series: [{ key: 'thanh_tien', label: 'Doanh thu (VND)' }] },
      { id: 'c_spdv', title: 'Số đơn chưa có vốn theo SPDV', type: 'bar', table: 'don_spdv', x: 'spdv', series: [{ key: 'so_don', label: 'Số đơn' }] },
    ],
  },

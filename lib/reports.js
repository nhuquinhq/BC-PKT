...
const cpvTeamReport = (code, bu) => ({
  ...
  charts: [
    ...
    { id: 'c_spdv', title: `GMV – PL2A theo SPDV · ${code}`, type: 'bar', table: 'kqkd_spdv', x: 'spdv', series: [{ key: 'gmv', label: 'GMV' }, { key: 'pl2a', label: 'PL2A' }] },
  ],
});
...
export const REPORTS = [
  ...
  /* ---------------------------------------------------------- PKT8 */
  {
    ...
    charts: [
      ...
      { id: 'c_team', title: 'GMV – PL2A theo Team', type: 'bar', table: 'kqkd_team', x: 'team', series: [{ key: 'gmv', label: 'GMV' }, { key: 'pl2a', label: 'PL2A' }] },
      { id: 'c_spdv', title: 'GMV – PL2A theo SPDV', type: 'bar', table: 'kqkd_spdv', x: 'spdv', series: [{ key: 'gmv', label: 'GMV' }, { key: 'pl2a', label: 'PL2A' }] },

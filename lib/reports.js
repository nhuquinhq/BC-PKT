...
const QLTT_SHEET = { url: QLTT_SHEET_URL, endpoint: '/api/qltt', qs: { thang: '7,8' } };
...
export const REPORTS = [
  ...
  /* --------------------------------------------------------- PKT21 */
  {
    code: 'PKT21',
    slug: 'pkt21',
    name: 'Báo cáo CPV QLTT (C100 + C200)',
    short: 'CPV QLTT',
    nav: 'CPV QLTT — WGG · VX101',
    tier: 3,
    sla: 'Ngày 5',
    periods: ['day', 'week', 'month'],
    defaultPeriod: 'month',
    source: 'Báo cáo kinh doanh QLTT · T1–T6 bản chốt, tháng đang chạy đọc trực tiếp',
    sheet: { ...QLTT_SHEET, mode: 'qltt', label: 'Báo cáo kinh doanh QLTT' },
    purpose: [
      'Hai team WGG và VX101 đang bán được bao nhiêu, giá vốn ăn bao nhiêu phần doanh thu?',
    ...
    tables: [
      {
        ...
        title: 'So sánh theo TEAM',
        totals: true,
        hint: 'AST tính vào VX101. Giá vốn của CTV Ngoài xếp vào AR (phải trả NCC), phần còn lại vào CO; COGS = CO + AR.',
        columns: [
          { key: 'team', label: 'Team', type: 'text' },
          { key: 'so_don', label: 'Số đơn', type: 'num' },
          { key: 'gmv', label: 'GMV', type: 'money' },
    ...
    charts: [
      { id: 'c_team', title: 'GMV theo TEAM = COGS + PL1 (xếp chồng)', type: 'bar', table: 'qltt_team', x: 'team', series: [{ key: 'cogs', label: 'COGS', stack: true }, { key: 'pl1', label: 'PL1', stack: true }, { key: 'ty_le_co', label: '% COGS/GMV', kind: 'line' }], tip: [{ key: 'gmv', label: 'GMV' }, { key: 'so_don', label: 'Số đơn', type: 'num' }] },
      { id: 'c_thang', title: 'Theo THÁNG = COGS + PL1 (xếp chồng)', type: 'bar', table: 'qltt_thang', x: 'thang', series: [{ key: 'cogs', label: 'COGS', stack: true }, { key: 'pl1', label: 'PL1', stack: true }, { key: 'ty_le_co', label: '% COGS/GMV', kind: 'line' }], tip: [{ key: 'gmv', label: 'GMV' }, { key: 'so_don', label: 'Số đơn', type: 'num' }] },
      { id: 'c_nhom', title: 'GMV theo nhóm hàng', type: 'bar', table: 'qltt_nhom', x: 'team', series: [{ key: 'gmv_ban_nick', label: 'Bán nick', stack: true }, { key: 'gmv_dv_tu_dong', label: 'DV tự động', stack: true }, { key: 'gmv_dv_thu_cong', label: 'DV thủ công', stack: true }, { key: 'gmv_minigame', label: 'Minigame', stack: true }] },
      { id: 'c_don', title: 'Số đơn theo tháng', type: 'bar', table: 'qltt_thang', x: 'thang', series: [{ key: 'gmv', label: 'GMV' }, { key: 'so_don', label: 'Số đơn', kind: 'line', num: true, color: '#D96F00' }] },
    ],
  },

...

  {
    ...
    tables: [
      ...
      },
      {
        ...
        id: 'pnl_don_vi',
        title: 'KQKD theo tầng — A10GG · Charging (bấm nút phía trên để đổi đơn vị)',
        hint: 'File CPV của hai đơn vị này chính là báo cáo KQKD nên bóc thẳng theo cây tầng, chốt cuối là PL7. Các tầng TỰ TÍNH (PL1 = RE − COGS · PL2 = PL1 − SE − ME − OP − FI · PL7 = PL2 − OV − CA − OT) chứ không lấy dòng PL2 sẵn trên file, vì dòng PL2 của Charging không khớp với chính PL7 của nó; công thức này khớp PL7 ở cả hai đơn vị. Dòng chi phí hiện số âm cho thấy nó trừ khỏi doanh thu. Số kế hoạch đã bị loại: A10GG bỏ tháng dự trù, Charging bỏ tháng chưa tới.',
        columns: [
          { key: 'ma', label: 'Mã', type: 'text' },
          { key: 'khoan_muc', label: 'Khoản mục', type: 'text' },
          { key: 'cong_thuc', label: 'Công thức', type: 'text' },
          { key: 'gia_tri', label: 'Kỳ đang lọc', type: 'money' },
          { key: 'tren_re', label: '% / RE', type: 'pct' },
        ],
      },
      {

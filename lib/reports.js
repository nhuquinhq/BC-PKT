...
const qlttTeamReport = (code, donVi, teamKey) => ({
  ...
  charts: [
    { id: 'c_thang', title: `Theo THÁNG = COGS + PL1 (xếp chồng) · ${donVi}`, type: 'bar', table: 'qltt_thang', x: 'thang', series: [{ key: 'cogs', label: 'COGS', stack: true }, { key: 'pl1', label: 'PL1', stack: true }, { key: 'ty_le_co', label: '% COGS/GMV', kind: 'line' }], tip: [{ key: 'gmv', label: 'GMV' }, { key: 'so_don', label: 'Số đơn', type: 'num' }] },
    { id: 'c_nhom', title: 'GMV theo nhóm hàng, từng tháng', type: 'bar', table: 'qltt_nhom_thang', x: 'thang', series: [{ key: 'gmv_ban_nick', label: 'Bán nick', stack: true }, { key: 'gmv_dv_tu_dong', label: 'DV tự động', stack: true }, { key: 'gmv_dv_thu_cong', label: 'DV thủ công', stack: true }, { key: 'gmv_minigame', label: 'Minigame', stack: true }] },
    ...
    { id: 'c_team', title: 'Đối chiếu hai đơn vị QLTT = COGS + PL1', type: 'bar', table: 'qltt_team', x: 'team', series: [{ key: 'cogs', label: 'COGS', stack: true }, { key: 'pl1', label: 'PL1', stack: true }, { key: 'ty_le_co', label: '% COGS/GMV', kind: 'line' }], tip: [{ key: 'gmv', label: 'GMV' }, { key: 'so_don', label: 'Số đơn', type: 'num' }] },
  ],
});

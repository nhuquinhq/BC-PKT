...
const cpvTeamReport = (code, bu) => ({
  ...
  charts: [
    { id: 'c_ngay', title: `Doanh thu theo ngày = Giá vốn + Lợi nhuận (xếp chồng) · ${code}`, type: 'bar', table: 'cpv_ngay', x: 'ngay', series: [{ key: 'gia_von', label: 'Giá vốn', stack: true }, { key: 'loi_nhuan', label: 'Lợi nhuận', stack: true }, { key: 'ty_le_co', label: '% CO/DT', kind: 'line' }] },
    { id: 'c_san', title: `Doanh thu theo Sàn = Giá vốn + Lợi nhuận (xếp chồng) · ${code}`, type: 'bar', table: 'cpv_san', x: 'san', series: [{ key: 'gia_von', label: 'Giá vốn', stack: true }, { key: 'loi_nhuan', label: 'Lợi nhuận', stack: true }, { key: 'ty_le_co', label: '% CO/DT', kind: 'line' }] },

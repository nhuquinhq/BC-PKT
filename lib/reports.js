...
/* Tháng ĐANG CHẠY (09/2026) — file chủ đạo đọc live.
   ...
   ĐỌC THEO HAI ĐƯỜNG, và đường CHÍNH là /export trên file gốc chứ không phải
   bản công bố. Đo lại ngày 15/09, 5 lượt mỗi đường:
     export    5/5 lượt · 1,3–1,6s mỗi lượt
     công bố   3/5 lượt · hai lượt trả HTTP 307 rỗng sau 110s
   Bản công bố đã thành hên xui đúng như file T8 hồi trước, nên xuống làm
   đường dự phòng. /api/cpv xen kẽ hai đường theo từng lượt.
   Đường gviz thì KHÔNG dùng được cho file này: tải nhanh (2,5s, 5/5) nhưng
   bỏ trống tên cột "Thành tiền GMV" nên đọc ra tiền bằng 0. */
const CPV_SHEET_URL = 'https://docs.google.com/spreadsheets/d/1WQdk90dz0Ddrh4C7exhuqHfNnD-DH616Ms0vUeDSNZw/edit?gid=0';
const CPV_SHEET_URL_B = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vS0Tldb2hmR8TxnYC_un9q0tpgpm3RCyN3O7oJimo17gP4EpagCRwEPwpqMr2BjdZtXeRVOcthy23PX/pubhtml?gid=0&single=true';

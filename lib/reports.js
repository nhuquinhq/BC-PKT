...
export const REPORTS = [
  ...
  /* ---------------------------------------------------------- PKT8 */
  {
    ...
    sheet: {
      url: 'https://docs.google.com/spreadsheets/d/e/2PACX-1vS8v730AMvL4_1VC131-HLHBECPrYMtLmv02TkTtpFuXlQEGtVSPpR1URMQ5sOhB6_LbnATeDwZUk__/pubhtml?gid=0&single=true',
      gid: '0',
      mode: 'order_cpv',
    ...
    tables: [
      {
        ...
        columns: [
          ...
          { key: 'gmv', label: 'GMV', type: 'money' },
          { key: 'pl1', label: 'PL1', type: 'money' },
          { key: 'pct_pl1', label: '% PL1/GMV', type: 'pct' },
          { key: 'pl2a', label: 'PL2A', type: 'money' },
          { key: 'pct_pl2a', label: '% PL2A/GMV', type: 'pct' },
          { key: 'arpo', label: 'ARPO', type: 'money' },
        ],
      },
      {
      ...
      },
      {
        ...
        columns: [
          ...
          { key: 'ti_le_fail', label: 'Tỉ lệ thất bại', type: 'pct' },
          { key: 'don_huy', label: 'Đơn hoàn hủy', type: 'num' },
          { key: 'ti_le_huy', label: 'Tỉ lệ hoàn hủy', type: 'pct' },
        ],
      },
      {
        id: 'don_spdv',
      ...
      },
      {
        ...
        columns: [
          ...
          { key: 'ty_le_co', label: '% CO/DT', type: 'pct' },
          { key: 'bien_ln', label: 'Biên LN', type: 'pct' },
        ],
      },
      {
        id: 'cpv_san',

...
export const REPORTS = [
  ...
  /* --------------------------------------------------------- PKT12 */
  {
    ...
    tables: [
      {
        ...
        totals: true,
        hint: 'Cộng lên từ dữ liệu NGÀY của sheet Daily.Report — ngày nào đọc trực tiếp được thì lấy số mới nhất, còn lại giữ bản chốt.',
        columns: [
          { key: 'thang', label: 'Tháng', type: 'text' },
          { key: 'gmv', label: 'GMV', type: 'money' },
    ...
    charts: [
      ...
      { id: 'c_nhom', title: 'Doanh thu theo nhóm hàng', type: 'bar', table: 'cpv_nhom', x: 'thang', series: [{ key: 're_giftcard', label: 'Giftcard', stack: true }, { key: 're_tien_ich', label: 'Tiện ích', stack: true }, { key: 're_steam', label: 'Steam', stack: true }], tip: [{ key: 're', label: 'Tổng doanh thu' }, { key: 'gmv', label: 'GMV' }] },
      { id: 'c_ngay', title: 'GMV theo ngày = Giá vốn + PL1 (xếp chồng)', type: 'bar', table: 'cpv_ngay', x: 'ngay', series: [{ key: 'co', label: 'Giá vốn', stack: true }, { key: 'pl1', label: 'PL1', stack: true }, { key: 'ty_le_co', label: '% CO/GMV', kind: 'line' }], tip: [{ key: 'gmv', label: 'GMV' }, { key: 're', label: 'Doanh thu' }, { key: 'so_don', label: 'Số đơn', type: 'num' }] },
      { id: 'c_don', title: 'Doanh thu (cột) & số đơn (đường) theo tháng', type: 'bar', table: 'cpv_thang', x: 'thang', series: [{ key: 're', label: 'Doanh thu' }, { key: 'so_don', label: 'Số đơn', kind: 'line', num: true, color: '#D96F00' }], tip: [{ key: 'gmv', label: 'GMV' }] },
    ],
  },
  ...CPV_TEAM_REPORTS,
  ...CPV_SAN_REPORTS,

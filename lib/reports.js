...
export const REPORTS = [
  ...
  /* --------------------------------------------------------- PKT13 */
  {
    ...
    charts: [
      {
        id: 'c_a10_trend',
        title: 'RE — CO — PL7 theo tháng',
        type: 'line',
        table: 'a10_thang',
        x: 'thang',
        series: [
          { key: 're', label: 'Doanh thu' },
          { key: 'co', label: 'Giá vốn' },
          { key: 'pl7', label: 'Lãi/Lỗ' },
        ],
      },
      {
        ...
        x: 'thang',
        series: [
          { key: 'co', label: 'COGS — Giá vốn', stack: true },
          { key: 'se', label: 'SE — Bán hàng', stack: true },
          { key: 'me', label: 'ME — Marketing', stack: true },
          { key: 'op', label: 'OP — Vận hành', stack: true },
          { key: 'ov', label: 'OV — Chi phí chung', stack: true },
          { key: 're', label: 'RE — Doanh thu', kind: 'line', num: true },
        ],
      },
      {
        ...
        pct: true,
        series: [
          { key: 'ty_le_co', label: '% COGS/RE' },
          { key: 'ty_le_se', label: '% SE/RE' },
          { key: 'ty_le_me', label: '% ME/RE' },
          { key: 'ty_le_op', label: '% OP/RE' },
          { key: 'ty_le_ov', label: '% OV/RE' },
          { key: 'bien_pl7', label: '% PL7/RE (Contribution Margin)', kind: 'line' },
        ],
      },
    ],
  },

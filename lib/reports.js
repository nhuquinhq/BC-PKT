...
const CPV_V3_URL = 'https://docs.google.com/spreadsheets/d/1AIJYxsS-SKcE-DVFWom0DqQsGJmvIo03JzBViCLJe3M/edit?gid=0';
const CPV_API_V3_URL = 'https://docs.google.com/spreadsheets/d/1MgKdAkn_shglL0xoduuUnqhKTmJDwpCilUnJgwpmAEQ/edit?gid=0';

export const BOT_CPV_SHEET = {
  url: CPV_V3_URL,
  gid: '0',
  api: [{ url: CPV_API_V3_URL, gid: '0' }],
  label: 'Báo cáo đơn hàng V3 · tab đơn hàng (gid 0)',
};

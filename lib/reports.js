...
const cpvTeamReport = (code, bu) => ({
  ...
  charts: [
    { id: 'c_ngay', title: `Doanh thu – Giá vốn theo ngày & % CO/DT · ${code}`, type: 'bar', table: 'cpv_ngay', x: 'ngay', series: [{ key: 'thanh_tien', label: 'Doanh thu' }, { key: 'gia_von', label: 'Giá vốn' }, { key: 'ty_le_co', label: '% CO/DT', kind: 'line' }] },
    { id: 'c_san', title: `Theo Sàn & % CO/DT · ${code}`, type: 'bar', table: 'cpv_san', x: 'san', series: [{ key: 'thanh_tien', label: 'Doanh thu' }, { key: 'gia_von', label: 'Giá vốn' }, { key: 'ty_le_co', label: '% CO/DT', kind: 'line' }] },
...
export const REPORTS = [
  ...
  /* ---------------------------------------------------------- PKT8 */
  {
    ...
    charts: [
      { id: 'c_ngay', title: 'Doanh thu – Giá vốn theo ngày & % CO/DT', type: 'bar', table: 'cpv_ngay', x: 'ngay', series: [{ key: 'thanh_tien', label: 'Doanh thu' }, { key: 'gia_von', label: 'Giá vốn' }, { key: 'ty_le_co', label: '% CO/DT', kind: 'line' }] },
      ...
      { id: 'c_san', title: 'Doanh thu – Giá vốn theo Sàn & % CO/DT', type: 'bar', table: 'cpv_san', x: 'san', series: [{ key: 'thanh_tien', label: 'Doanh thu' }, { key: 'gia_von', label: 'Giá vốn' }, { key: 'ty_le_co', label: '% CO/DT', kind: 'line' }] },

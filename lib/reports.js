...
const CPV_SHEET_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vS8v730AMvL4_1VC131-HLHBECPrYMtLmv02TkTtpFuXlQEGtVSPpR1URMQ5sOhB6_LbnATeDwZUk__/pubhtml?gid=0&single=true';
/* File API trực tiếp từ sàn — hiện chỉ có G1, G2; được ưu tiên khi trùng Order ID */
const CPV_API_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vTwoaNaItJfQPZDNom-HB06ea0jxglfgeiWZ8Sj-8dWwneE26NCU8NhEQpaXzIAnZc0XI0bbLOzG04i/pubhtml?gid=0&single=true';
const CPV_API = { url: CPV_API_URL, gid: '0' };
...
const cpvTeamReport = (code, bu) => ({
  ...
  sheet: { url: CPV_SHEET_URL, gid: '0', mode: 'order_cpv', teamFilter: code, api: CPV_API, label: `Đơn hàng BE · Team ${code}` },
  purpose: [
  ...
  charts: [
    { id: 'c_ngay', title: `Doanh thu vs Giá vốn theo ngày · ${code}`, type: 'line', table: 'cpv_ngay', x: 'ngay', series: [{ key: 'thanh_tien', label: 'Doanh thu' }, { key: 'gia_von', label: 'Giá vốn' }] },
    { id: 'c_san', title: `Theo Sàn · ${code}`, type: 'bar', table: 'cpv_san', x: 'san', series: [{ key: 'thanh_tien', label: 'Doanh thu' }, { key: 'gia_von', label: 'Giá vốn' }] },
    { id: 'c_spdv', title: `GMV – PL1 – PL2A theo SPDV · ${code}`, type: 'bar', table: 'kqkd_spdv', x: 'spdv', series: [{ key: 'gmv', label: 'GMV' }, { key: 'pl1', label: 'PL1' }, { key: 'pl2a', label: 'PL2A' }] },
...
export const REPORTS = [
  ...
  /* ---------------------------------------------------------- PKT8 */
  {
    ...
    sheet: {
      ...
      mode: 'order_cpv',
      api: CPV_API,
      label: 'Giá Vốn HQS10000 - BE - 07/2026 · tab Data',
    },
    purpose: [
    ...
    tables: [
      ...
      },
      {
        ...
        hint: 'Đơn có Order ID xuất hiện ở cả hai file (kể cả khác đuôi -1/-2). Báo cáo phía trên chỉ tính các đơn này MỘT LẦN theo module Quản lý đơn hàng; bảng module tính ở cả hai dòng. Cột chênh lệch = Doanh thu API − Doanh thu BE.',
        totals: true,
        columns: [
    ...
    charts: [
      { id: 'c_ngay', title: 'Doanh thu vs Giá vốn theo ngày (VND)', type: 'line', table: 'cpv_ngay', x: 'ngay', series: [{ key: 'thanh_tien', label: 'Doanh thu' }, { key: 'gia_von', label: 'Giá vốn' }] },
      { id: 'c_team', title: 'GMV – PL1 – PL2A theo Team', type: 'bar', table: 'kqkd_team', x: 'team', series: [{ key: 'gmv', label: 'GMV' }, { key: 'pl1', label: 'PL1' }, { key: 'pl2a', label: 'PL2A' }] },
      { id: 'c_spdv', title: 'GMV – PL1 – PL2A theo SPDV', type: 'bar', table: 'kqkd_spdv', x: 'spdv', series: [{ key: 'gmv', label: 'GMV' }, { key: 'pl1', label: 'PL1' }, { key: 'pl2a', label: 'PL2A' }] },
      { id: 'c_san', title: 'Doanh thu – Giá vốn theo Sàn', type: 'bar', table: 'cpv_san', x: 'san', series: [{ key: 'thanh_tien', label: 'Doanh thu' }, { key: 'gia_von', label: 'Giá vốn' }] },

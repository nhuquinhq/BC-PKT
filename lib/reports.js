...
/* Các tháng trước của module Quản lý đơn hàng — cùng form với file tháng 7.
   Sang tháng mới chỉ cần thêm { url, gid } vào danh sách này. */
const CPV_SHEET_T6_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vRV-lP9ASz3mNzIe_WE4YZIFHCR0vofv3ZkPSxVk9pMnJRbOdwEn2XIKx_sgGnZK8LPcLCLIuuOGuM4/pubhtml?gid=0&single=true';
const CPV_SHEET_T5_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vTbG9l3TkQnQhRvYovHqeLdNICx7yHEAMNngBfKo86P_sNbxK3mt3gTR2cIoKv9p1KPC6tE71BzklLz/pubhtml?gid=0&single=true';
const CPV_MAINS = [
  { url: CPV_SHEET_T6_URL, gid: '0' },
  { url: CPV_SHEET_T5_URL, gid: '0' },
];
...
const cpvTeamReport = (code, bu) => ({
  ...
  sheet: { url: CPV_SHEET_URL, gid: '0', mains: CPV_MAINS, mode: 'order_cpv', teamFilter: code, api: CPV_API, label: `Đơn hàng BE · Team ${code}` },
  purpose: [

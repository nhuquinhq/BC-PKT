...
export const REPORTS = [
  ...
  /* --------------------------------------------------------- PKT12 */
  {
    ...
    charts: [
      ...
      { id: 'c_ngay', title: 'GMV theo ngày = Giá vốn + PL1 (xếp chồng)', type: 'bar', table: 'cpv_ngay', x: 'ngay', series: [{ key: 'co', label: 'Giá vốn', stack: true }, { key: 'pl1', label: 'PL1', stack: true }, { key: 'ty_le_co', label: '% CO/GMV', kind: 'line' }] },

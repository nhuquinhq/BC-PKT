...
export const REPORTS = [
  ...
  /* --------------------------------------------------------- PKT20 */
  {
    ...
    periods: ['day', 'week', 'month'],
    defaultPeriod: 'month',
    source: 'Gộp: đơn hàng BE HQS · lịch sử ví HQS · Daily.Report Ritokey · Báo cáo QLTT · FINANCIAL REPORT A10GG',

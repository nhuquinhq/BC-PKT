...
export const REPORTS = [
...

  {
    ...
    tables: [
      ...
      {
        /* Bảng này do PnlDonViBoard đọc trực tiếp, KHÔNG nhập tay. Để
           riêng chứ không trộn vào pnl_by_dim vì bảng kia là số PKT
           điền — đẩy live vào đó là ghi đè mất. */
        id: 'pnl_don_vi',
        title: 'P&L các dự án đọc tự động — A10GG · Charging',
        totals: true,
        hint: 'Đọc thẳng từ báo cáo TOA của từng đơn vị, cộng theo kỳ đang lọc. Hai đơn vị này chỉ có số theo THÁNG và không tách GMV riêng nên GMV = RE. Số kế hoạch đã bị loại: A10GG bỏ các tháng dự trù, Charging bỏ các tháng chưa tới (mới chỉ ghi trước chi phí phân bổ). A10GG còn có độ trễ thu tiền ~45 ngày nên tháng vừa qua thường đã có chi phí mà doanh thu còn 0.',
        columns: [
          { key: 'ten', label: 'Đơn vị', type: 'text' },
          { key: 'so_thang', label: 'Số tháng', type: 'num' },
          { key: 're', label: 'RE', type: 'money' },
          { key: 'cogs', label: 'COGS', type: 'money' },
          { key: 'pl1', label: 'PL1', type: 'money' },
          { key: 'se', label: 'SE', type: 'money' },
          ...
          { key: 'ty_le_co', label: '% CO/RE', type: 'pct', totalOf: ['cogs', 're'] },
          { key: 'bien_pl7', label: '% PL7/RE', type: 'pct', totalOf: ['pl7', 're'] },
        ],
      },
      {
        id: 'dq_check',

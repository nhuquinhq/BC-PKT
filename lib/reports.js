  ...
  /* ---------------------------------------------------------- PKT8 */
  {
    ...
    tables: [
      ...
      },
      {
        ...
        hint: 'Quản lý đơn hàng: VND lấy sẵn trên file. API sàn: chỉ có nguyên tệ — GMV và Giá vốn nhân với TỶ GIÁ TUẦN (cột Tỷ giá tuần của module Quản lý đơn hàng, theo ngày hoàn tất). Cột Tỷ giá BQ là tỷ giá bình quân thực áp.',
        totals: true,
        columns: [

...
export const REPORTS = [
  ...
  /* --------------------------------------------------------- PKT12 */
  {
    ...
    charts: [
      { id: 'c_thang', title: 'Doanh thu theo THÁNG = Giá vốn + PL1 (xếp chồng)', type: 'bar', table: 'cpv_thang', x: 'thang', series: [{ key: 'co', label: 'Giá vốn', stack: true }, { key: 'pl1', label: 'PL1', stack: true }, { key: 'ty_le_co', label: '% CO/RE', kind: 'line' }], tip: [{ key: 're', label: 'Doanh thu' }, { key: 'gmv', label: 'GMV (gồm hoàn hủy)' }, { key: 'so_don', label: 'Số đơn', type: 'num' }] },
      { id: 'c_nhom', title: 'Doanh thu theo nhóm hàng', type: 'bar', table: 'cpv_nhom', x: 'thang', series: [{ key: 're_giftcard', label: 'Giftcard', stack: true }, { key: 're_tien_ich', label: 'Tiện ích', stack: true }, { key: 're_steam', label: 'Steam', stack: true }], tip: [{ key: 're', label: 'Tổng doanh thu' }, { key: 'gmv', label: 'GMV (gồm hoàn hủy)' }] },
      { id: 'c_ngay', title: 'Doanh thu theo NGÀY = Giá vốn + PL1 (xếp chồng)', type: 'bar', table: 'cpv_ngay', x: 'ngay', series: [{ key: 'co', label: 'Giá vốn', stack: true }, { key: 'pl1', label: 'PL1', stack: true }, { key: 'ty_le_co', label: '% CO/RE', kind: 'line' }], tip: [{ key: 're', label: 'Doanh thu' }, { key: 'gmv', label: 'GMV (gồm hoàn hủy)' }, { key: 'so_don', label: 'Số đơn', type: 'num' }] },
      { id: 'c_don', title: 'Doanh thu (cột) & số đơn (đường) theo tháng', type: 'bar', table: 'cpv_thang', x: 'thang', series: [{ key: 're', label: 'Doanh thu' }, { key: 'so_don', label: 'Số đơn', kind: 'line', num: true, color: '#D96F00' }], tip: [{ key: 'gmv', label: 'GMV (gồm hoàn hủy)' }] },
    ],
  },
  ...CPV_TEAM_REPORTS,
  ...CPV_SAN_REPORTS,
